 ...
 */
module.exports.STATUS = Message.STATUS = 'status';
Message.prototype.__formats[Message.STATUS] = function(type, metadata) {
    return {
        type: type,
        data: {
 ...
 */
module.exports.UPDATE = Message.UPDATE = 'update';
Message.prototype.__formats[Message.UPDATE] = function(type, metadata) {
    return {
        type: type,
        data: {
            from: metadata.session.id,
 ...
 */
module.exports.DELETE = Message.DELETE = 'delete';
Message.prototype.__formats[Message.DELETE] = function(type, metadata) {
    return {
        type: type,
        data: {
            from: metadata.session.id,
